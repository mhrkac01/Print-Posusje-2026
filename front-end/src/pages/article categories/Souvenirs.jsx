...
import magnet from "../../assets/posusje souvenirs/Suvenir magnet 1.png";
import shirt from "../../assets/posusje souvenirs/Suvenir majica 1.png";
            ...
            <div className="px-4 py-6 sm:py-8 md:p-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-7xl mx-auto justify-items-center sm:justify-items-stretch">
                    <div className="w-full max-w-sm sm:max-w-none">
                        <Article title="Magnet" image={magnet} text="Magnet" price="" />
                    </div>
                    <div className="w-full max-w-sm sm:max-w-none">
                        <Article title="Majica kratkih rukava" image={shirt} text="Majica kratkih rukava" price="" />
                    </div>
                    <div className="w-full max-w-sm sm:max-w-none">
                        <Article title="Privjesak" image={keyring} text="Privjesak" price="" />
                    </div>
                    <div className="w-full max-w-sm sm:max-w-none">
                        <Article title="Šalica" image={mug} text="Šalica" price="" />
                    </div>
                </div>
            </div>
        </>
